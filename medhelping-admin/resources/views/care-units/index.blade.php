<x-app-layout>
    <x-slot name="header">
        ...
        <x-primary-button><a href="{{ route('care-units.create') }}">Cadastrar</a></x-primary-button>
    </x-slot>
                            ...
                            @foreach($careUnits as $careUnit)
                                <tr class="bg-white">
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900 flex gap-3">
                                        <a href="{{ route('care-units.edit', $careUnit->id) }}">
                                            <x-warning-button>
                                                <i class="fas fa-edit"></i>
                                            </x-warning-button>
                                        </a>
                                        <x-danger-button href="{{ route('care-units.destroy', $careUnit->id) }}" data-confirm-delete="true">
