    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div>
                    <section>
                        <form method="post" action="{{ route('shifts.store') }}" class="mt-6 space-y-6 flex flex-wrap gap-3">
                            @csrf
                            ...
                            <div class="w-full lg:w-[32%]">
                                ...
                                <x-text-input id="entry_time" name="entry_time" type="time" class="mt-1 block w-full" :value="old('entry_time')" required autofocus autocomplete="entry_time" />
                                <x-input-error class="mt-2" :messages="$errors->get('entry_time')" />
                            </div>

                            <div class="w-full lg:w-[32%]">
                                <x-input-label for="out_time" value="Hora de saída" />
                                <x-text-input id="out_time" name="out_time" type="time" class="mt-1 block w-full" :value="old('out_time')" required autofocus autocomplete="out_time" />
