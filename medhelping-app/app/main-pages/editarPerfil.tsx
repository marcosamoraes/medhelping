...
export default function EditarPerfil() {
    ...
    <SideMenu/></SidebarProvider>
        <ScrollView className="w-screen px-6 bg-[#00021C]">
            ...
            <TouchableOpacity disabled={loading} onPress={()=> handleEditProfile()} activeOpacity={0.8} className="flex-row w-full bg-[#03dadbb2] justify-center pt-2 pb-1 rounded-xl my-3 items-center"><Text className="text-white font-700 text-sm ml-2">Atualizar perfil</Text></TouchableOpacity>
