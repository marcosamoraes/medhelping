...
export default function Login(){
    ...
    <View className="bg-[#01061C] flex-1 items-center">
      ...
      <TouchableHighlight><Text className='font-bold text-white text-base my-5'> Esqueci minha senha </Text></TouchableHighlight>
      <TouchableHighlight><Text className='font-bold text-[#03DADB] text-base mt-5 mb-3'> Novo no app? Criar conta! </Text></TouchableHighlight>
    </View>
    </>)
}